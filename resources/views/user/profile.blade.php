                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <div class="mt-3">
                          <h4 class="text-dark">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</h4>
                    ...
                    <div class="row gutters-sm">
                        <div class="col-sm-12 mb-3">
                          <div class="card h-100">
                            <div class="card-body">
                              <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">Team Selection Form</h6>
                                ...
                                <form action="{{ route('submit-picks') }}" method="post" id="team-selection-form">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-5 ml-5 mr-2 border 1px p-3 mb-5 team-box" data-team-id="1" style="border-radius: 10px">
                                            <div class="row">
                                                <div class="col-md-4">
                                        ...
                                        <div class="col-md-5 ml-5 mr-2 border 1px p-3 mb-5 team-box" data-team-id="2" style="border-radius: 10px">
                                            <div class="row">
                                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 ml-5 mr-2 border 1px p-3 mb-5 team-box" data-team-id="3" style="border-radius: 10px">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="{{ asset('assets/images/itly.avif') }}" alt="" style="border-radius:10px" height="60px">
                                                </div>
                                                <div class="col-md-8">
                                        ...
                                        <span class="ml-4"> VS </span>
                                        <div class="col-md-5 ml-5 mr-2 border 1px p-3 mb-5 team-box" data-team-id="4" style="border-radius: 10px">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="{{ asset('assets/images/france.png') }}" alt="" style="border-radius:10px" height="60px">
                                                </div>
                                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 ml-5 mr-2 border 1px p-3 mb-5 team-box" data-team-id="5" style="border-radius: 10px">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="{{ asset('assets/images/england.jpg') }}" alt="" style="border-radius:10px" height="60px">
                                                </div>
                                                <div class="col-md-8">
                                        ...
                                        <span class="ml-4"> VS </span>
                                        <div class="col-md-5 ml-5 mr-2 border 1px p-3 mb-5 team-box" data-team-id="6" style="border-radius: 10px">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="{{ asset('assets/images/scotland.png') }}" alt="" style="border-radius:10px" height="60px">
                                                </div>
                                                <div class="col-md-7">
