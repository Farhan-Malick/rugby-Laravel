...
<body>
    ...
    <div class="container" style="padding-top: 10% ; margin-top:-2%">
        <div class="container">
            <div class="row">
                                    ...
                                    <div class="col-lg-7 ">
                                        <form action="{{ route('paymentMethod') }}" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form__div">
                                                        <input type="text" name="cardNumber" style="color: black" class="form-control text-dark" placeholder=" ">
                                                ...
                                                <div class="col-6">
                                                    <div class="form__div">
                                                        <input type="text" name="mmYY"  style="color: black" class="form-control text-dark" placeholder=" ">
                                                ...
                                                <div class="col-6">
                                                    <div class="form__div">
                                                        <input type="password"  name="cvv"  style="color: black" class="form-control text-dark" placeholder=" ">
                                                        <label for="" class="form__label">cvv code</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form__div">
                                                        <input type="text"  name="cardName"  style="color: black" class="form-control text-dark" placeholder=" ">
