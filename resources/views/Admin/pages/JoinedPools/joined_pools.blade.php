                        ...
                        <table id="data-table-default"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col">Pool Owner Name</th>
                            ...
                            <tbody>
                                @foreach($joined_pools as $key=>$join_pool)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td>{{$join_pool->user->first_name}}</td>
                                    <td>{{$join_pool->created_pool_id}}</td>
                                    <td>{{$join_pool->user_name}}</td>
                                    <td>{{$join_pool->pool_name}}</td>
                                    <td>{{$join_pool->created_at->diffForHumans()}}</td>
