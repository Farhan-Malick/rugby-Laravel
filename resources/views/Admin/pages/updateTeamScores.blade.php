    ...
    <div id="page-container"
        ...
        <div id="content" class="content">
            ...
            <ol class="breadcrumb float-xl-right">
                ...
                <li class="breadcrumb-item active">Update Team Scores</li>
            </ol>
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header">Update Team Scores</h1>
            <!-- end page-header -->
            <div class="row">
                <!-- begin col-6 -->
                <div class="col-xl-12">
                            ...
                            <div class="card shadow-sm mb-3">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title fw-600 text-center">
                                        Update Team Scores Here
                                    </h5>
                                    @if (session('msg'))
                                    <div class="col-sm-6 mx-auto " style="text-align: center;  font-size:20px">
                                        {{ session('msg') }}</div>
                                    @endif
                                    <form method="POST" action="{{ url('/Accouncements/updateTeamScores', $match->id) }}">
                                        @csrf
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputTitle4">Update Team Scores</label>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputTitle4"> <b>Winner Team</b></label>
                                                <input type="text" class="form-control"  name="winnerTeam" 
                                                value="{{$match->winnerTeam}}"  
                                                />
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputTitle4">Looser Team</label>
                                                <input type="text" class="form-control"  name="looserTeam" 
                                                value="{{$match->looserTeam}}" 
                                                />
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputTitle4">Add Score For Winner</label>
                                                <input type="number" class="form-control" value="{{ $match->winner }}" name="winner" 
                                                />
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputTitle4">Add Score For Looser</label>
                                                <input type="number" class="form-control" value="{{$match->looser}}"  name="looser" 
                                                />
                                            </div>
                                        </div>
