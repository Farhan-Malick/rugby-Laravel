...
<body>
                            ...
                            <div class="card shadow-sm mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-6 mx-auto " style="text-align: center;  font-size:20px">
                                        {{ session('msg') }}</div>
                                    @endif
                                    <form method="post" action="{{URL('/Admin/CreatePool')}}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputTitle4">Pool Listing Name</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Enter pool Listing Name here" name="poolname" />
                                            </div>

                                        </div>
                                        {{-- <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputTitle4">Pool Date</label>
                                                <input type="date" class="form-control" placeholder="Pool Date"
                                                    name="Pool_date" />
                                            </div>
                                        </div> --}}
                                        ...
                                        {{-- <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputTitle4">Location</label>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputTitle4">Pool Category</label>
                                                <input type="text" class="form-control" placeholder="Pool Category"
                                                    name="pool_category" />
                                            </div>
                                        ...
                                        {{-- <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label for="inputTitle4">Start Time</label>
                                                <input type="time" class="form-control" placeholder="Start Time"
                                                    name="start_time" />
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputTitle4">End Time</label>
    ...
    <script src="{{ asset('adminassets/plugins/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}">
    </script>
    ...
    <script src="{{ asset('adminassets/plugins/@danielfarrell/bootstrap-combobox/js/bootstrap-combobox.js') }}">
    </script>
